...
class MPZPConditions(Base):
    ...
    parking_required_info: Mapped[str | None] = mapped_column(Text, nullable=True)
    parking_spaces_per_unit: Mapped[float | None] = mapped_column(Numeric(10, 2), nullable=True)
    parking_spaces_per_100sqm_services: Mapped[float | None] = mapped_column(Numeric(10, 2), nullable=True)
    parking_disability_requirement: Mapped[str | None] = mapped_column(Text, nullable=True)
    conservation_protection_zone: Mapped[str | None] = mapped_column(Text, nullable=True)
    nature_protection_zone: Mapped[str | None] = mapped_column(Text, nullable=True)
    noise_emission_limits: Mapped[str | None] = mapped_column(Text, nullable=True)
